...
## dashboard
## ringkasan
async def get_dashboard_ringkasan_hr(db: AsyncSession, role: str):
    today = date.today()
    ...
    target_status = "menunggu_hr" if role == "hr" else "menunggu_direktur"
...
## edit karyawan
async def edit_karyawan(user_id: int, data: dict, db: AsyncSession) -> str:
