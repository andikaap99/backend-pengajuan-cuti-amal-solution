...
from app.schemas.log_cuti import LogCutiCreate, RiwayatCutiOut, PengajuanOngoingOut
...
async def get_my_ongoing_leaves(user_id: int, db: AsyncSession) -> list[PengajuanOngoingOut]:
