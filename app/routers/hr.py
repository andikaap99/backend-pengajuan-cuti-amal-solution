...
async def get_dashboard_hr(
    ...
    return await get_dashboard_ringkasan_hr(db, current_user.id_user, current_user.role)
...
async def get_dashboard_persetujuan(
    ...
    return await get_persetujuan(db, current_user.role)
...
async def update_karyawan(
    ...
    message = await edit_karyawan(user_id, update_date, db, background_tasks)
...
async def get_log_penambahan_kerja_endpoint(
    ...
    return await get_log_penambahan_kerja(db)
